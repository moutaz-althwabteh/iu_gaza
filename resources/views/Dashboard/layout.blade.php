...
<body>
    ...
    <body id="kt_body"
                                        ...
                                        <form>
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane active show p-8"
                                                    ...
                                                    <!--begin::Scroll-->
                                                    <div class="scroll pr-7 mr-n7 ps" data-scroll="true"
        ...
        <div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
            ...
            <!--end::Header-->
            <!--begin::Content-->
            <div class="offcanvas-content pr-5 mr-n5 scroll ps ps--active-y" style="height: 44px; overflow: hidden;">
                <!--begin::Header-->
        ...
        <div id="kt_quick_cart" class="offcanvas offcanvas-right p-10">
            ...
            <div class="offcanvas-content">
                ...
                <div class="offcanvas-wrapper mb-5 scroll-pull scroll ps ps--active-y"
                    ...
                    <div class="ps__rail-y" style="top: 0px; right: -2px; height: 385px;">
            ...
            <div class="offcanvas-content px-10">
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show pt-3 pr-5 mr-n5 active scroll ps ps--active-y"
                        id="kt_quick_panel_logs" role="tabpanel" style="height: 40px; overflow: hidden;">
                        <!--begin::Section-->
                        <div class="mb-15">
                        ...
                        <div class="ps__rail-y" style="top: 0px; height: 40px; right: 0px;">
                            <div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 40px;"></div>
                        </div>
                    </div>
                    <!--end::Tabpane-->
                    ...
                    <div class="tab-pane fade pt-2 pr-5 mr-n5 scroll ps" id="kt_quick_panel_notifications"
                        role="tabpanel" style="height: 40px; overflow: hidden;">
                        <!--begin::Nav-->
        ...
        <div id="kt_demo_panel" class="offcanvas offcanvas-right p-10">
            ...
            <div class="offcanvas-content">
                <!--begin::Wrapper-->
                <div class="offcanvas-wrapper mb-5 scroll-pull scroll ps ps--active-y"
                    style="height: 459px; overflow: hidden;">
        ...
        <svg id="SvgjsSvg1001" width="2" height="0" xmlns="http://www.w3.org/2000/svg" version="1.1"
            ...
            <path id="SvgjsPath1004"
                d="M-1 200L-1 200C-1 200 84.16666666666667 200 84.16666666666667 200C84.16666666666667 200 168.33333333333334 200 168.33333333333334 200C168.33333333333334 200 252.5 200 252.5 200C252.5 200 336.6666666666667 200 336.6666666666667 200C336.6666666666667 200 420.8333333333333 200 420.8333333333333 200C420.8333333333333 200 505 200 505 200C505 200 505 200 505 200 ">
            </path>
        </svg>
